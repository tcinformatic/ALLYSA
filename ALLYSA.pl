...
print "           ╚═╝  ╚═╝╚══════╝╚══════╝╚═╝   ╚══════╝╚═╝  ╚═╝              \n";
print "                                                                       \n";
print " By Tc informatics: https://www.youtube.com/channel/UCZjk_5PJyIrQHk_eu1NQaNg\n";                                           
                                                                                                              
                                                                                      
print "=====================================\n";
print "Use: perl $0 login wordlist.txt\n";
print "=====================================\n";
exit; }
...
if (!defined $success)
{
print "\033[1;31m[-] $password -> Error \n";
close SSL;
}
else
{
print "\033[1;32m\n########################################################\n";
print "[+] \033[1;32mConstrasena Encontrada: $password\n";
print "\033[1;32m########################################################\n\n";
close SSL;
exit;
}
